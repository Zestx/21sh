...
#    Updated: 2020/01/20 20:21:19 by qbackaer         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = sources/21sh.c sources/display.c sources/input.c sources/input_tools.c \
	   sources/lexing/lex_tools.c sources/lexing/lex_ll.c \
	   sources/tokenize.c sources/tokenize_tools.c
OBJS = 21sh.o display.o input.o input_tools.o lex_tools.o lex_ll.o \
	   tokenize.o tokenize_tools.o
